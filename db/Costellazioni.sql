...
(9, 'Cassiopea', 'Rappresenta una regina mitologica', 47.6, 70.5, 2, 63),
(10, 'Castori e Polluce', 'Rappresenta i gemelli mitologici Castore e Polluce', 10.3, 35.3, 98, 118),
(11, 'Cefeo', 'Rappresenta un re mitologico', 56.6, 77.3, 1, 69),
...
(20, 'Crocifisso', 'Rappresenta una croce', -62.0, -55.9, 180, 191),
...
(25, 'Dragone', 'Rappresenta un drago', 53.3, 86.4, 110, 275),
...
(30, 'Giraffa', 'Rappresenta una giraffa', 52.6, 86.1, 58, 194),
...
(42, 'Orsa Maggiore', 'Rappresenta un''orsa', 40.1, 73.1, 135, 230),
(43, 'Orsa Minore', 'Rappresenta un''orsa', 66.6, 89.0, 0, 100),
...
(69, 'Zodiaco', 'Rappresenta la fascia zodiacale', -10.0, 10.0, 0, 360);
